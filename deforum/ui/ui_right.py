...
def on_ui_tabs():
    ...
    slopcore_css = """
    /* Slopcore gradient for Generate button - ULTRA aggressive selectors for Gradio 4 */
    #deforum_generate,
    ...
    div#audio_sync_button button,
    [id*="audio_sync_button"] *,
    #audio_sync_fewer_button *,
    #audio_sync_fewer_button,
    button#audio_sync_fewer_button,
    #audio_sync_fewer_button button,
    div#audio_sync_fewer_button button,
    [id*="audio_sync_fewer_button"] *,
    #audio_sync_more_button *,
    #audio_sync_more_button,
    button#audio_sync_more_button,
    #audio_sync_more_button button,
    div#audio_sync_more_button button,
    [id*="audio_sync_more_button"] *,
    #audio_ai_generate_button *,
    #audio_ai_generate_button,
    button#audio_ai_generate_button,
    #audio_ai_generate_button button,
    div#audio_ai_generate_button button,
    [id*="audio_ai_generate_button"] *,
    .slopcore-button,
    button.slopcore-button,
    .slopcore-button button,
    .slopcore-button *,
    button[id="audio_sync_button"],
    button[id="audio_sync_fewer_button"],
    button[id="audio_sync_more_button"],
    button[id="audio_ai_generate_button"],
    .primary#audio_sync_button,
    .secondary#audio_sync_fewer_button,
    .secondary#audio_sync_more_button,
    .primary#audio_ai_generate_button,
