...
class TuningTestConfig(BaseModel):
    ...
    rotation_factor_min: Optional[float] = Field(None, ge=-30.0, le=-0.5)
    rotation_factor_max: Optional[float] = Field(None, ge=-30.0, le=-0.5)
    ...
    raft_rotation_factor: Optional[float] = Field(None, ge=-10.0, le=-0.5, description="Fixed rotation factor for RAFT tests")
