...
def visualize_schedules(
    ...
    NOTE: This shows the BASE camera path (spline), NOT the final result with shakify.
    Shakify adds high-frequency jitter that would clutter the 3D path visualization.
    Use the frame overlap simulator to see the final result with shakify applied.
    ...
    """
    # Parse all schedules (BASE schedules only, no shakify)
