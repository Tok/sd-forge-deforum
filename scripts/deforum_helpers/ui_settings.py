...
def on_ui_settings():
    ...
    opts.add_option("deforum_disable_nonessential_emojis", OptionInfo(False, "Disables non-essential emojis.", gr.Checkbox, {"interactive": True}, section=section))
    ...
    opts.add_option("deforum_own_line_for_prompt_srt", OptionInfo(False, "Put 'prompt' on its own line in subtitles if present.", gr.Checkbox, {"interactive": True}, section=section))
    ...
    opts.add_option("deforum_save_gen_info_as_srt_params", OptionInfo(['Prompt'], "Choose which animation params are to be saved to the .srt file (Frame # and Seed will always be saved):", ui_components.DropdownMulti, lambda: {"interactive": True, "choices": srt_ui_params}, section=section))
    opts.add_option("deforum_simple_subtitles", OptionInfo(False, "Only write prompt into subtitles.", gr.Checkbox, {"interactive": True}, section=section))
