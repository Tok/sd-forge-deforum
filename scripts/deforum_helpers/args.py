...
def WanArgs():
    ...
    return {
        ...
        "wan_enable_prompt_enhancement": {
            ...
            "type": "checkbox",
            "value": False,
            "info": "Enable QwenPromptExpander to automatically enhance and refine prompts for better video quality"
        },
        "wan_qwen_model": {
            "label": "Qwen Model",
            "type": "dropdown",
        ...
        "wan_enable_movement_analysis": {
            ...
            "type": "checkbox",
            "value": True,
            "info": "Analyze Deforum movement schedules and append movement descriptions to prompts for better video dynamics"
        },
